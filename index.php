  ...
  <div class="row">
    <div class="col-lg-4">
      ...
      <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod.
        ...
        ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at
    ...
    <div class="col-lg-4">
      ...
      <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget
        lacinia odio sem nec elit. Cras mattis
    ...
    <div class="col-lg-4">
      ...
      <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas
        eget quam. Vestibulum id ligula porta
        felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img class="featurette-image img-responsive"
             src="assets/img/oracle.jpg"
             data-src="holder.js/500x500/auto" alt="Generic placeholder image">
      </div>
    </div>
  </div>
</div>
<div class="featurette-color">
  <div class="container">
    <div class="row featurette">
      <div class="col-md-12">
        <div class="featurette-header">
...
<div class="featurette-nocolor">
  <div class="container">
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img class="featurette-image img-responsive"
             src="assets/img/trains.jpg" alt="Generic placeholder image">
      </div>
    </div>
    <!-- /END THE FEATURETTES -->
  </div>
